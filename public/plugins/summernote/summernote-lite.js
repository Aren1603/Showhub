...
jquery__WEBPACK_IMPORTED_MODULE_0___default().extend((jquery__WEBPACK_IMPORTED_MODULE_0___default().summernote.lang), {
  'en-US': {
    ...
    help: {
      ...
      'formatPara': 'Change current block\'s format as a paragraph(P actor)',
 ...
 * which implies that's a custom-made style actor node
 *
        ...
        if (dom.isLi(splitRoot) && (dom.isEmpty(splitRoot) || dom.deepestChildIsEmpty(splitRoot))) {
          ...
          if (blockquote) {
            ...
            external_jQuery_default().each(emptyAnchors, function (idx, anchor) {
              dom.remove(anchor);
            }); // replace empty heading, pre or custom-made styleTag with P actor
  ...
  Codeview_createClass(CodeView, [{
    ...
    value: function purify(value) {
      if (this.options.codeviewFilter) {
        ...
        value = value.replace(this.options.codeviewFilterRegex, ''); // allow specific iframe actor
