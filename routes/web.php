...
Route::group(
    ['namespace' => 'App\Http\Controllers\Search', 'prefix' => 'search'],
    function () {
...
Route::group(
    ['namespace' => 'App\Http\Controllers\Rejisor', 'prefix' => 'rejisor'],
    function () {
...
Route::group(
    ['namespace' => 'App\Http\Controllers\Actor', 'prefix' => 'actor'],
    function () {
...
Route::group(
    ['namespace' => 'App\Http\Controllers\Genre', 'prefix' => 'genre'],
    function () {
...
Route::group(
    ['namespace' => 'App\Http\Controllers\Year', 'prefix' => 'year'],
    function () {
...
Route::group(
    ['namespace' => 'App\Http\Controllers\Personal', 'prefix' => 'personal'],
    function () {
        Route::group(
            ['namespace' => 'Main'],
            function () {
...
Route::group(
    ['namespace' => 'App\Http\Controllers\Admin', 'prefix' => 'admin', 'middleware' => 'admin'],
    function () {
        Route::group(
            ['namespace' => 'Main'],
            function () {
        ...
        Route::group(
            ['namespace' => 'Rejisor', 'prefix' => 'rejisors'],
            function () {
